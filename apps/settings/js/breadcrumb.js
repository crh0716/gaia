var Breadcrumb = function(_root, settings) {
  var root = _root;
  var breadcrumbContainer = _root.querySelector('.breadcrumb-container');
  var hashQueue = [];

  var onPanelChange = function(event) {
    var prevHash = null;
    var curHash = event.detail.current;
  ...
  window.addEventListener('panelready', onPanelChange);
};
